...
nifty_100_stocks = [
    ...
    "LTI.NS", "MPHASIS.NS", "MRF.NS", "NAUKRI.NS", "PFC.NS", "TRENT.NS","INDHOTEL.NS","JKCEMENT.NS","CHAMBLFERT.NS","BHEL.NS",
    "BSOFT.NS", "HAL.NS", "JINDALSTEL.NS","ADANIENT.NS",
    "OBEROIRLTY.NS", "MPHASIS.NS","APOLLOTYRE.NS","MUTHOOTFIN.NS","COFORGE.NS","WIPRO.NS","LTIM.NS","HDFCAMC.NS","DIXON.NS","DEEPAKNTR.NS"
]
...
def app(data_bull,data_bear):
    ...
    with col1:
        ...
        if len(data_bull_date)>0:
            data_bull_date=data_bull_date.sort_values("Time",ascending=False)
